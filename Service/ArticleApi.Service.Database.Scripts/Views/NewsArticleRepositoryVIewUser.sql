...
/****** Object:  View [dbo].[View_User]    Script Date: 16/06/2018 16:50:20 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT        dbo.[User].FirstName, dbo.[User].LastName, dbo.[User].IsPublisher, dbo.UserCredentials.UserEmail, dbo.[User].UserId
FROM            dbo.[User] INNER JOIN
                         dbo.UserCredentials ON dbo.[User].UserId = dbo.UserCredentials.UserId
GO
